...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\routes\\\\punctureRepair.tsx"' + id);
  };
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "flex items-center justify-center h-screen", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "mt-16 max-w-md p-6 bg-white rounded shadow-md mx-auto", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: "text-3xl font-bold mb-4 text-center", style: {
        color: "#112D4E"
      }, children: "Puncture Repair Service" }, void 0, false, {
        fileName: "app/routes/punctureRepair.tsx",
        lineNumber: 63,
        columnNumber: 9
      }, this),
...
_s(PunctureRepairService, "F/dY84rDIAQ2IuXcojXOn4shq0M=");
_c = PunctureRepairService;
var _c;
$RefreshReg$(_c, "PunctureRepairService");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
  PunctureRepairService as default
};
//# sourceMappingURL=/build/routes/punctureRepair-IQSBCVSU.js.map
